    ...
    <div class="container">
      ...
      <div class="flex-w flex-sb-m p-b-52">
        <div class="flex-w flex-l-m m-tb-10">
          ...
          <button
            class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
            @click="addParam({ subCategory: 'thit-nhung-lau' })"
          >
            Thịt nhúng lẩu
          </button>
          ...
          <button
            class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
            @click="addParam({ subCategory: 'hai-san-nhung-lau' })"
          >
            Hải sản nhúng lẩu
          </button>
          ...
          <button
            class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
            @click="addParam({ subCategory: 'vien-tha-lau' })"
          >
            Viên thả lẩu
          </button>
          <button
            class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
            @click="addParam({ subCategory: 'nam-nhung-lau' })"
          >
            Nấm nhúng lẩu
          </button>
          ...
          <button
            class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
            @click="addParam({ subCategory: 'rau-nhung-lau' })"
          >
            Rau nhúng lẩu
          </button>
          <!-- 
          <button
            class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
            @click="addParam({ subCategory: 'cot-lau-hadilao' })"
          >
            Nước lẩu thêm
          </button> -->
        </div>
  ...
  setup() {
    ...
    const addParam = (param) => {
      switch (param.subCategory) {
        case "thit-nhung-lau":
          page.value = 1;
          currentPath.value = "Thịt nhúng lẩu";
          break;
        case "hai-san-nhung-lau":
          page.value = 1;
          currentPath.value = "Hải sản nhúng lẩu";
          break;
        case "vien-tha-lau":
          page.value = 1;
          currentPath.value = "Viên thả lẩu";
          break;
        case "nam-nhung-lau":
          page.value = 1;
          currentPath.value = "Nấm nhúng lẩu";
          break;
        case "rau-nhung-lau":
          page.value = 1;
          currentPath.value = "Rau nhúng lẩu";
          break;
        default:
          page.value = 1;
